...
Archimedes:
													tey call me te Archimedes ya know wim

Archimedes:
													now get movin foo 
"""

# NEW: assign PNGs here in the Inspector (per NPC)
...
func _on_body_entered(body: Node2D) -> void:
	...
	dialogue_ui.call("open_lines", pages) # if you’re using the portrait version, pass the extra args here
